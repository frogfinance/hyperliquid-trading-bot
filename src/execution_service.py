...
class HyperLiquidExecutionService:
    def __init__(self, eth_key: str):
        ...
        logging.info("hyperliquid loaded")
    ...
    def get_last_price(self, rawAssetName : str):
        ...
        while retry > 0:
            try:
                ...
                logging.info("Cannot get last price for " + symbol)
